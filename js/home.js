...
<div id="home-page">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-4">
                        <div class="header-cta">
                            ...
                            <button class="btn btn-danger btn-lg btn-bold" type="button" onclick="showTickets()">Tickets</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="collapse navbar-collapse navbar-center" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item nav-link-item bg-red">
                            <a onclick="showHome()" class="nav-link align-middle active" href="#">Home</a>
                        </li>
        ...
        <div class="container container-white">
            ...
            <section>
                <div class="main-content row">
                    ...
                    <!-- Teaser Cards -->
                    <div class="col-lg-8 col-12 main-content-padding">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8 card-body-align">
                                    <div class="card-body card-body-align">
                                        <a onclick="showImpressions()" class="main-section-link" href="#">
                        ...
                        <div class="mb-3 card-bg">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8 card-body-align">
                                    <div class="card-body card-body-align">
                                        <a onclick="showTickets()" class="main-section-link" href="#">
                    ...
                    <!-- Lineup -->
                    <div class="col-lg-4 col-8 artist-card-bg">
                        ...
                        <h4 class="artist-card">Bonobo</h4> 
                        <h4 class="artist-card">Death in Vegas</h4>
                        <h4 class="artist-card">Blood Orange</h4> <br>
            ...
            <section class="centered">
                <div class="cta-section">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-danger btn-lg cta-btn" onclick="showTickets()">Tickets</button>
                    </div>
                </div>
            </section>
        </div>
        ...
        <section>
            <div id="newsletter-section" class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 newsletter-text">
